...
(function (global, factory) {
	...
	*/
	...
	function _createSuper(Derived) { return function () { var Super = _getPrototypeOf(Derived), result; if (_isNativeReflectConstruct()) { var NewTarget = _getPrototypeOf(this).constructor; result = construct$3(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }
	...
	***************************************************************************** */
	...
	function _createSuper$1(Derived) { return function () { var Super = _getPrototypeOf(Derived), result; if (_isNativeReflectConstruct$2()) { var NewTarget = _getPrototypeOf(this).constructor; result = construct$3(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }
	...
	*/
	          ...
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	              ...
	              case 2:
	                ...
	                instanceOf(source$$1, source.Vector, "Source \"".concat(_this.source, "\" doesn't exists in the identity map."));
	                instanceOf(source$$1.getFeaturesCollection(), ol.Collection, "Source \"".concat(_this.source, "\" doesn't provide features collection."));
	...
	function _objectSpread$i(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context5; forEach$2(_context5 = ownKeys$j(Object(source$$1), true)).call(_context5, function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { defineProperties$1(target, getOwnPropertyDescriptors$2(source$$1)); } else { var _context6; forEach$2(_context6 = ownKeys$j(Object(source$$1))).call(_context6, function (key) { defineProperty$1(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	var script$t = {
	...
	function _objectSpread$k(target) { for (var i = 1; i < arguments.length; i++) { var source$$1 = arguments[i] != null ? arguments[i] : {}; if (i % 2) { var _context5; forEach$2(_context5 = ownKeys$l(Object(source$$1), true)).call(_context5, function (key) { _defineProperty(target, key, source$$1[key]); }); } else if (getOwnPropertyDescriptors$2) { defineProperties$1(target, getOwnPropertyDescriptors$2(source$$1)); } else { var _context6; forEach$2(_context6 = ownKeys$l(Object(source$$1))).call(_context6, function (key) { defineProperty$1(target, key, getOwnPropertyDescriptor$3(source$$1, key)); }); } } return target; }
	var script$D = {
